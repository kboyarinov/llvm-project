...
template <class _Tp>
struct __is_pair_specialization_impl : std::false_type {};

template <class _Tp, class _Up>
struct __is_pair_specialization_impl<pair<_Tp, _Up>> : std::true_type {};

template <class _Tp>
struct __is_pair_specialization : __is_pair_specialization_impl<remove_cvref_t<_Tp>> {};
...
template <class _Pair, class _Alloc, class _Tuple1, class _Tuple2>
    requires __is_pair_specialization<_Pair>::value
constexpr auto uses_allocator_construction_args(const _Alloc& __alloc, piecewise_construct_t, _Tuple1&& __x, _Tuple2&& __y) noexcept {
    return tuple{piecewise_construct,
                 apply([&__alloc](auto&&... __args1) {
                     return uses_allocator_construction_args<typename _Pair::first_type>(__alloc,
                                                                                       _VSTD::forward<decltype(__args1)>(__args1)...);
                 }, _VSTD::forward<_Tuple1>(__x)),
                 apply([&__alloc](auto&&... __args2) {
                     return uses_allocator_construction_args<typename _Pair::second_type>(__alloc,
...
constexpr auto uses_allocator_construction_args(const _Alloc& __alloc) noexcept {
    return uses_allocator_construction_args<_Pair>(__alloc, piecewise_construct, tuple{}, tuple{});
}
...
constexpr auto uses_allocator_construction_args(const _Alloc& __alloc, _Up&& __u, _Vp&& __v) noexcept {
    return uses_allocator_construction_args<_Pair>(__alloc,
                                                   piecewise_construct,
