...
// template <class U>
// polymorphic_allocator<T>::polymorphic_allocator(const polymorphic_allocator<U>& other) noexcept;
...
{
    {
        ...
        ASSERT_NOEXCEPT(std::pmr::polymorphic_allocator<char>(alloc1));
    }
    {
        const std::pmr::polymorphic_allocator<int> alloc1;
        std::pmr::polymorphic_allocator<char> alloc2 = alloc1;
