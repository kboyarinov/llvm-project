...
int main(int, char**)
{
    ...
    {
        testAllocateExcetionsForSize<1>();
        testAllocateExcetionsForSize<2>();
        testAllocateExcetionsForSize<4>();
        testAllocateExcetionsForSize<16>();
        testAllocateExcetionsForSize<73>();
    }
#endif
    return 0;
}
